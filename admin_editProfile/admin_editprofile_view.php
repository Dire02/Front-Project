...
<html lang= "fa">
	...
	<body>
		...
		<form action = "editprofile_controller.php?id=<?php echo $uid;?>" method = "post">
		<h2>
		<a href="../Home/home_controller.php"><i class = "fa fa-home"></i></a>
		ویرایش پروفایل</h2>

		<label for = "Rolls">سطح دسترسی</label>
		<input type = "radio" name = "Rolls" value = "admin" checked id = "AdminRoll">
			<label for = "AdminRoll"> ادمین</label>

		<input type = "radio" name = "Rolls" value = "Nuser" checked id = "UserRoll">
			<label for = "UserRoll">کاربر معمولی </label>
		...
		<br>
		<input type = "text" id="pass" name = "pass" placeholder = "a-z,1-9"value = <?php echo $userlist['pass'];?>>	
		<br>
